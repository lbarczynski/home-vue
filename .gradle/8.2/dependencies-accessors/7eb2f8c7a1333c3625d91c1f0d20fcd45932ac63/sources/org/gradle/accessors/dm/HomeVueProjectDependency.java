...
@NonNullApi
public class HomeVueProjectDependency extends DelegatingProjectDependency {

    @Inject
    public HomeVueProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
